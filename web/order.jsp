...
<div class="form-container">
    ...
    <form action="OrderServlet" method="post">
        ...
        <input type="text" id="creditCardId" name="creditCardId" size="25" />

        <label for="deliveryAddress">Delivery address:</label>
        <input type="text" id="deliveryAddress" name="deliveryAddress" size="25" />

        <label for="orderDate">Order date format(YYYY-MM-DD MM-SS):</label>
        <input type="text" id="orderDate" name="orderDate" size="25" />

        <label for="deliveryDate">Delivery date format(YYYY-MM-DD MM-SS):</label>
        <input type="text" id="deliveryDate" name="deliveryDate" size="25" />
